...
import io.revenium.metering.core.MultipartField
...
private fun serializePart(name: String, node: JsonNode): Sequence<Pair<String, InputStream>> =
    when (node.nodeType) {
                    ...
                    node
                        ...
                        .mapNotNull { element ->
                            when (element.nodeType) {
                                ...
                                JsonNodeType.OBJECT,
                                JsonNodeType.POJO ->
                                    throw ReveniumMeteringInvalidDataException(
        ...
        JsonNodeType.POJO,
        null ->
            throw ReveniumMeteringInvalidDataException("Unexpected JsonNode type: ${node.nodeType}")
    }
