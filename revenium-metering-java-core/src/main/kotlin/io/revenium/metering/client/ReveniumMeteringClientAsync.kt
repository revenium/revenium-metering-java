...
/**
 * A client for interacting with the Revenium Metering REST API asynchronously. You can also switch
 ...
 * may call [close].
 */
interface ReveniumMeteringClientAsync {
     ...
     * this client.
     */
    fun sync(): ReveniumMeteringClient
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): ReveniumMeteringClientAsync

    /** Event Metering Operations */
    fun events(): EventServiceAsync

    /** API Metering Operations */
    fun apis(): ApiServiceAsync
    ...
    /**
     * A view of [ReveniumMeteringClientAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
        ...
        /** API Metering Operations */
        fun apis(): ApiServiceAsync.WithRawResponse
