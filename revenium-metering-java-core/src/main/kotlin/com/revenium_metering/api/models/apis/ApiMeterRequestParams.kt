...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        private val credential: JsonField<String> = JsonMissing.of(),
        @JsonProperty("method")
        @ExcludeMissing
        private val method: JsonField<Method> = JsonMissing.of(),
        @JsonProperty("remoteHost")
        @ExcludeMissing
        private val remoteHost: JsonField<String> = JsonMissing.of(),
        @JsonProperty("requestMessageSize")
        @ExcludeMissing
        private val requestMessageSize: JsonField<Long> = JsonMissing.of(),
