...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        private val responseCode: JsonField<Long> = JsonMissing.of(),
        @JsonProperty("transactionId")
        @ExcludeMissing
        private val transactionId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("backendLatency")
        @ExcludeMissing
        private val backendLatency: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("contentType")
        @ExcludeMissing
        private val contentType: JsonField<String> = JsonMissing.of(),
        @JsonProperty("gatewayLatency")
        @ExcludeMissing
        private val gatewayLatency: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("responseMessageSize")
        @ExcludeMissing
        private val responseMessageSize: JsonField<Long> = JsonMissing.of(),
        @JsonProperty("totalDuration")
        @ExcludeMissing
        private val totalDuration: JsonField<Long> = JsonMissing.of(),
        @JsonAnySetter
