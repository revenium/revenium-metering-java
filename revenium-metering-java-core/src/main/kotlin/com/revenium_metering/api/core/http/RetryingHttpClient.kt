...
private constructor(
    ...
    private fun shouldRetry(throwable: Throwable): Boolean =
        // Only retry IOException and ReveniumMeteringIoException, other exceptions are not intended
        // to be
        // retried.
        throwable is IOException || throwable is ReveniumMeteringIoException
