...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../revenium-metering-java-core/src/main/resources/META-INF/proguard/revenium-metering-java-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../revenium-metering-java-core/src/main/resources/META-INF/proguard/revenium-metering-java-core.pro",
