...
import io.revenium.metering.core.http.HttpRequestBody
import io.revenium.metering.core.http.HttpResponse
import io.revenium.metering.errors.ReveniumMeteringIoException
...
private constructor(@JvmSynthetic internal val okHttpClient: okhttp3.OkHttpClient) : HttpClient {
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw ReveniumMeteringIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
        ...
        call.enqueue(
            object : Callback {
                ...
                override fun onFailure(call: Call, e: IOException) {
                    future.completeExceptionally(ReveniumMeteringIoException("Request failed", e))
                }
            }
        )
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("REVENIUM_METERING_LOG")?.lowercase()) {
