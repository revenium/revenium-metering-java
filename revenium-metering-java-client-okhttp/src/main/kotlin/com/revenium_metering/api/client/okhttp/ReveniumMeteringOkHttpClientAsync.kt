...
package com.revenium_metering.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.revenium_metering.api.client.ReveniumMeteringClientAsync
import com.revenium_metering.api.client.ReveniumMeteringClientAsyncImpl
import com.revenium_metering.api.core.ClientOptions
import com.revenium_metering.api.core.Sleeper
import com.revenium_metering.api.core.Timeout
import com.revenium_metering.api.core.http.Headers
import com.revenium_metering.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [ReveniumMeteringClientAsync] with [OkHttpClient] as
 * the underlying [HttpClient].
 */
class ReveniumMeteringOkHttpClientAsync private constructor() {

    companion object {

        /**
         * Returns a mutable builder for constructing an instance of [ReveniumMeteringClientAsync].
         */
         ...
         */
        @JvmStatic fun fromEnv(): ReveniumMeteringClientAsync = builder().fromEnv().build()
    }

    /** A builder for [ReveniumMeteringOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.revenium_metering.api.core.jsonMapper]. The default is usually
         ...
         *
         * Defaults to the production environment: `https://api.revenium.io/meter/`.
         */
