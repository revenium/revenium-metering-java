...
import com.revenium_metering.api.client.ReveniumMeteringClientImpl
...
/**
 * A class that allows building an instance of [ReveniumMeteringClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class ReveniumMeteringOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [ReveniumMeteringClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): ReveniumMeteringClient = builder().fromEnv().build()
    }

    /** A builder for [ReveniumMeteringOkHttpClient]. */
